...
With a few example proofs, where we use the \texttt{do} notation to increase readability by avoiding many nested monadic binds.
...
{0=0} ; {0=0}
> let pre = ruleFantasy (And (PropVar $ Eq Z Z) (PropVar $ Eq Z Z)) ruleSepR :: Either String (Proof (PropCalc (FOL Integer)))
|- 0=0 /\ 0=0 -> 0=0
> let post = ruleFantasy (PropVar $ Eq Z Z) Right :: Either String (Proof (PropCalc (FOL Integer)))
|- 0=0 -> 0=0
