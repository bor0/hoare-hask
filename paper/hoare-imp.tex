...
Move this out. As with \texttt{eval}, the \texttt{Either} data type is used to distinguish between provable and not provable terms. Several commands can be chained as follows:
...
For the Hoare conditional rule, similarly to the Hoare sequence rule, we are checking whether the corresponding values match.
