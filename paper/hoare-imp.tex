...
For example, here's how we can implement \textbf{Joining Rule} and \textbf{Sep Rule} in Haskell:
...
Similarly as we did in the example for the H-Conditional rule, we get that $B$ is \texttt{(PropVar \$ Eq Z Z)} and $C$ is \texttt{CSkip}.
