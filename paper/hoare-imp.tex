...
Restriction: \texttt{applyPropRule} should not be used with any of the elimination rules (\texttt{ruleSepL}/\texttt{ruleSepR}) within the hypothesis of an implication, since we may end up with incorrect formulas such as $A \to A \land B$.
