...
|- <(P)=(0)> -> <All Q:(P)=(0)>
> let eg = ruleSpec (axiom2 A) A (Var A)
|- ((A)+(0))=(A)
> ruleExistence eg B [(GoLeft,[],[GoLeft]),(GoRight,[],[])] -- apply to As on both sides
|- Exists B:((B)+(0))=(B)
> ruleExistence eg B [(GoLeft,[],[GoLeft])] -- apply to A on left side
|- Exists B:((B)+(0))=(A)
> ruleExistence eg B [(GoLeft,[],[GoLeft]),(GoLeft,[],[GoRight])] -- applying to A and 0 (different terms) doesn't work
|- ((A)+(0))=(A)
\end{lstlisting}
