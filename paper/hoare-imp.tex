...
Even though our implementation is simple enough, it can still prove some very useful facts. Consider the following:
...
To make it more obvious, we can add two additional optimization rules that state $a + b - b = a$ and $a - (a - b) = b$:
